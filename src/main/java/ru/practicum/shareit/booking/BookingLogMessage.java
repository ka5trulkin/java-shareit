...
public class BookingLogMessage {
    ...
    public static final String BOOKING_ADDED = "Бронирование ID:'{}' добавлено";
    public static final String BOOKING_APPROVED = "Статус бронирования ID:'{}' изменен";
    public static final String GET_BOOKING = "Получение бронирования ID:'{}'";
    public static final String GET_BOOKING_LIST_BY_BOOKER = "Получение списка бронирования пользователя ID:'{}'";
    public static final String GET_BOOKING_LIST_BY_OWNER = "Получение списка бронирования владельца ID:'{}'";
}