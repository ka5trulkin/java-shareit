...
public class ItemRequestMessage {
    ...
    public static final String ITEM_REQUEST_ADDED = "Запрос для поиска вещи ID:'{}' добавлен";
    public static final String GET_REQUESTS_BY_OWNER = "Получение списка запросов для владельца ID:'{}'";
    public static final String GET_REQUESTS_BY_USER = "Получение списка запросов для пользователя ID:'{}'";
    public static final String GET_REQUEST = "Получение запроса ID:{} на поиск вещи";
}